...
def run_training_entry():
    ...
    parser.add_argument('--learning_rate', type=float, default=2e-3, help='Specify the initial learning rate')
    parser.add_argument('--n_epochs', type=int, default=2500, help='Specify the number of epochs to train for')
